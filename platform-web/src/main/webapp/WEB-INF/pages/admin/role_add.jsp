		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form id="roleForm" action="${pageContext.request.contextPath }/role_save.do" method="post">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>名称</td>
						<td><input type="text" value="${role.name}" name="name" class="easyui-validatebox" data-options="required:true" /></td>
					</tr>
					<tr>
						<td>描述</td>
						<td>
					...
					<tr>
						<td>授权</td>
						<td>
							<input type="hidden" value="${role.functionIds}" id="functionIds" name="functionIds" />
                    ...
                    $.ajax({
                        ...
                        success : function(data) {
                            ...
                            if(zNodes && zNodes.rows){
                                var treeObj = $.fn.zTree.init($("#functionTree"), setting, zNodes.rows);
                                var nodes = treeObj.getNodes();
                                $.each(nodes, function (i, item) {
                                    selectNodes(treeObj, item, $("#functionIds").val().split(","));
                                })
                            }
