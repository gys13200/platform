...
<div data-options="region:'center'">
	<form id="functionForm" action="${pageContext.request.contextPath }/function_save.action" method="post">
					...
					<tr>
						...
						<td>
							<input name="parentFunction.id" class="easyui-combobox" 
								data-options="valueField:'id',textField:'name',url:'${pageContext.request.contextPath }/function_list'"/>
						</td>
					</tr>
					<tr>
						<td>描述</td>
